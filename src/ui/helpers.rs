...
/// Space-separated because the leader is a *sequence*, not a chord: `^F1`
/// reads as Ctrl+F1, and that misreading names a real binding — the bare
/// F-keys select project tabs.
