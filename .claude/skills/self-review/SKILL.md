...
- 인자가 전달되면 (`/self-review <base-branch>`) 해당 브랜치를 기준점으로 사용한다.
...
- roadmap / workstream 문서가 있으면 현재 workstream 범위 내인지 확인한다.
...
- **무시**: 이전 리뷰 단계에서 이미 다뤄진 항목, 스타일 선호, 범위 밖 개선 제안. 개별 내용은 보고하지 않되, 건수와 대표 사유는 보고 형식에 포함한다.
